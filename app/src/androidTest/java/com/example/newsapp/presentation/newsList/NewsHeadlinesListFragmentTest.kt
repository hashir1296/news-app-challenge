...
class NewsHeadlinesListFragmentTest {
    ...
    fun setUp() {
        ...
        InstrumentationRegistry.getInstrumentation().runOnMainSync {
            ...
            navController.setGraph(com.example.newsapp.R.navigation.nav_graph)
        }
    ...
    fun itemWithText_doesNotExist() {
        ...
        onView(ViewMatchers.withId(com.example.newsapp.R.id.rvHeadLines)) // scrollTo will fail the test if no item matches.
            .perform(
